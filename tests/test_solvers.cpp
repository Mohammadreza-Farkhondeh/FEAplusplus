...
protected:
    ...
    void SetUp() override {
        // Create nodes
        Node* node1 = new Node(0, 0, 0); // Assuming Node constructor takes (x, y, z) coordinates
        Node* node2 = new Node(1, 0, 0);
        nodes.push_back(node1);
        nodes.push_back(node2);

        // Create material with appropriate parameters
        Material* material = new Material(210e9, 0.3, 7850, 250e6, 0.01); // Example parameters
